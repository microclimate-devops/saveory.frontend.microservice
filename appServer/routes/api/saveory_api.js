...
var DEV_RESP = {
	...
	recipes: JSON.stringify([
		{author:"Bob Saget", description:"The simplest breakfast you'll ever make",id:"1",
			ingredients:[
				{name: "Cereal", tag: "null", description: "Kellog's Brand", quantity: "1", unit: "cup", has:"0"},
				{name: "Milk", tag: "dairy", description: "Kellog's Brand", quantity: "0.5", unit: "cup", has"0"}
			],
			instructions:"Step 1: Pour cereal in bowl; Step 2: Pour milk in bowl",
			name:"Cereal and Milk",
			tag: ["dairy", "vegetarian"],
			_id: {$oid: "598b67330e8682c5920d1ed3"}
		},
		{name: "Masala Steak", id: "4", author: "Gordon Ramsey", tag: ["fried", "beef"],
			ingredients: [
				{name: "Steak", tag: [], description: "2-inch-thick bone-in porterhouse steak", quantity: "3", unit: "pound", has="1"},
				{name: "Salt", tag: [], description: "Kosher", quantity: "1", unit: "tbsp", has:"0"},
				{name: "Sugar", tag: [], description: "Light Brown", quantity: "1", unit: "tbsp", has:"0"},
				{name: "Pepper", tag: [], description: "Cayenne", quantity: "0.5", unit: "tsp", has="0"},
				{name: "Oil", tag: [], description: "Rice bran or vegetable", quantity: "0.5", unit: "tsp", has="1"},
				{name: "Butter", tag: [], description: "Unsalted", quantity: "4", unit: "tbsp", has="1"},
				{name: "Masala", tag: [], description: "or any spice mix of choice", quantity: "1", unit: "tsp",has:"1"}
			],
			isntructions:"Step 1: Score steak ¼\" deep over all surfaces in a crosshatch pattern, making cuts 1\" apart (this helps the seasoning penetrate). <br/>Step 2: Mix salt, brown sugar, and cayenne in a small bowl and rub all over steak, massaging into score marks and crevices. <br/>Step 3: Upend steak on the flat side of the bone on a wire rack set inside a rimmed baking sheet and chill overnight (or a solid 12 hours). This will dry out the meat and intensify the flavor of the rub. <br/>Step 4: Then freeze (still upright) until solid, at least 6 hours and up to 24 hours. <br/>Step 5: Preheat oven to 200°. Pour rice bran oil or vegetable oil into a 12\" skillet, preferably cast iron, to a depth of ¾\". Oil should be deep enough to come halfway up side of steak; add a little more oil to skillet if needed. <br/>Step 6: Heat oil over medium-high until probe thermometer registers 350° (or clip a deep-fry thermometer to the side of your skillet if you prefer). Transfer steak straight from freezer to skillet and cook, turning once, until deeply browned all over and a crisp crust has formed, about 3 minutes per side. <br/>Step 7: Transfer steak back to rack on baking sheet (reserve skillet and oil) and roast in oven until no longer frozen (the interior will still be cold but thawed enough to allow the insertion of the probe thermometer), 30–35 minutes. <br/>Step 8: Meanwhile, cook butter in a small saucepan over medium heat until it foams, then browns, 5–8 minutes. Remove from heat and stir in vadouvan. Let cool, 20–25 minutes. Strain through a fine-mesh sieve into a small bowl; discard solids. <br/>Step 9: Remove steak from oven and spoon one-third of spice-infused butter over, making sure to coat both sides. Poke thermometer probe in the center of the strip side and roast steak, basting every 30 minutes or so with remaining butter, until thermometer registers 120°, 1–1½ hours. Alternatively, use an instant-read thermometer to check steak every 15 minutes after the first hour, and every 5 minutes after 1½ hours. Once thawed, the temperature of the steak will rise about 1 degree a minute. <br/>Step 10: Remove steak from oven. Reheat reserved oil in skillet back to 350° over medium-high. Fry steak a second time, turning once, until a deeply browned crust forms on all sides, about 2 minutes per side. <br/>Step 11: Transfer back to rack and let rest 10 minutes. (Frying again will re-crisp your crust, lock in juices, and develop more flavor.) <br/>Step 12: Use a thin knife to carve along both sides of the bone to remove strip and filet; cut into ½"-thick slices. Arrange on a platter alongside bone. Pour any butter and juices that have accumulated in baking sheet over top.",
			description:"Slow-Roasted, Twice-Fried Porterhouse Steak"
		}
	]),
